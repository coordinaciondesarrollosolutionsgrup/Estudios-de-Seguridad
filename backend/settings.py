...
GOOGLE_CALENDAR_SYNC_ENABLED = env.bool("GOOGLE_CALENDAR_SYNC_ENABLED", default=False)
GOOGLE_CALENDAR_ID = env("GOOGLE_CALENDAR_ID", default="primary")
GOOGLE_CALENDAR_SERVICE_ACCOUNT_FILE = env("GOOGLE_CALENDAR_SERVICE_ACCOUNT_FILE", default="")
GOOGLE_CALENDAR_IMPERSONATE_USER = env("GOOGLE_CALENDAR_IMPERSONATE_USER", default="")
GOOGLE_CALENDAR_TIME_ZONE = env("GOOGLE_CALENDAR_TIME_ZONE", default=TIME_ZONE)
GOOGLE_CALENDAR_SEND_UPDATES = env("GOOGLE_CALENDAR_SEND_UPDATES", default="all")
